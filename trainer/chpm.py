...
class Trainer:
    ...
    def __init__(self, config):
        ...
        if resume_checkpoint_path:
            ...
            if layer_recall_init_ckpt:
                ...
                if bool(_YX_get(config.layer_recall, "layer_recall_dynamic_layer_enabled", False)):
                    dynamic_tokens = (
                    ...
                    layer_recall_missing = [
                        key for key in layer_recall_missing
                        if not any(token in key for token in dynamic_tokens)
                    ]
                if layer_recall_missing or layer_recall_unexpected:
                    raise RuntimeError(
    ...
    def _build_critical_resume_contract(self):
        ...
        layer_recall_semantic_keys = (
            ...
            "layer_recall_dynamic_layer_budget",
            "layer_recall_dynamic_layer_temperature",
            "layer_recall_dynamic_layer_embed_dim",
            "layer_recall_dynamic_layer_hidden_dim",
            "layer_recall_dynamic_layer_prior_scale",
